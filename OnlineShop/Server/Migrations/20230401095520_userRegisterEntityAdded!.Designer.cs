...
namespace OnlineShop.Server.Migrations
{
    ...
    [Migration("20230401095520_userRegisterEntityAdded!")]
    partial class userRegisterEntityAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShop.Shared.ProductVariant", b =>
                {
                    b.HasOne("OnlineShop.Shared.Product", "Product")
                        .WithMany("Varians")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineShop.Shared.ProductType", "ProductType")
                        .WithMany()
